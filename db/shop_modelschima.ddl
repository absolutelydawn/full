...
CREATE TABLE shop.membertbl (
    memberid      CHAR(8 BYTE) DEFAULT NULL NOT NULL,
    membername    NCHAR(5) DEFAULT NULL NOT NULL,
    memberaddress NVARCHAR2(20) DEFAULT NULL
)
...
CREATE TABLE shop.producttbl (
    productname NCHAR(4) DEFAULT '1' NOT NULL,
    cost        NUMBER(7) NOT NULL,
    makedate    DATE,
    company     NCHAR(5) DEFAULT '4',
    amount      NUMBER(3)
)
PCTFREE 10 PCTUSED 40 TABLESPACE users LOGGING
    STORAGE ( INITIAL 65536 NEXT 1048576 PCTINCREASE 0 MINEXTENTS 1 MAXEXTENTS 2147483645 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT
